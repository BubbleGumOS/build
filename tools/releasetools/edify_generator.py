...
class EdifyGenerator(object):
  ...
  def PrintBubbleGumBanner(self, android_version, bubblegum_version, build_id, build_date,
                                  security_patch, device):
    self.Print("----------------------------------------------")
    self.Print("                 BubbleGumOS")
    self.Print("                by BubbleGum team")
    self.Print("----------------------------------------------")
    self.Print(" Android version: %s"%(android_version))
    self.Print(" BubbleGum version: %s"%(bubblegum_version))
