...
""" % bcb_dev)
  ...
  is_plus = True
  bubblegum_version = target_info.GetBuildProp("org.bubblegum.version")
  android_version = target_info.GetBuildProp("ro.build.version.release")
  build_id = target_info.GetBuildProp("ro.build.id")
  build_date = target_info.GetBuildProp("org.bubblegum.build_date")
  security_patch = target_info.GetBuildProp("ro.build.version.security_patch")
  device = target_info.GetBuildProp("org.bubblegum.device")
  script.PrintBubbleGumBanner(android_version, bubblegum_version, build_id, build_date,
